            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('/daftar-produk'); ?>">Daftar Wisata</a></li>
                        <li class="breadcrumb-item active">Edit Destinasi</li>
                    </ol>
                </div>
                <div class="card-body">
                    <?php if (!empty($product) && is_array($product)): ?>
                        <form action="<?= site_url('edit-produk/' . $product['id_wisata']); ?>" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" id="gambar" name="gambar_wisata" class="form-control image_file"
